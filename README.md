...
**Proficient:** Java, Spring Boot, RDBMS/SQL, Apache Kafka, Docker, Kubernetes

**Competent:** Amazon Web Services, JUnit Testing, Bash Scripting, Microsoft Azure, C++
